...
\end{knitrout}
\caption{Collatz Plot, Seed 1313}
\label{CollatzPlot2}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{knitrout}
\caption{Collatz Plot, Under Specific Arguments}
\label{CollatzPlot3}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{canvas_collatz}\hldef{(}\hlkwc{colors} \hldef{=} \hlkwd{colorPalette}\hldef{(}\hlsng{"flora"}\hldef{),}
               \hlkwc{background} \hldef{=} \hlsng{"#304529"}\hldef{,}
               \hlkwc{n} \hldef{=} \hlnum{56}\hldef{,}
               \hlkwc{angle.even} \hldef{=} \hlopt{-}\hlnum{4.48}\hldef{,}
               \hlkwc{angle.odd} \hldef{=} \hlnum{0.071}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
%Code to insert a figure [H]ere
...
\end{knitrout}
\caption{Collatz Plot, ``Crocodile"}
\label{CollatzPlot4}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{zeroToTen} \hlkwb{<-} \hlnum{0}\hlopt{:}\hlnum{10}
\end{alltt}
\end{kframe}
\end{knitrout}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{output} \hlkwb{<-} \hlnum{2}\hlopt{^}\hldef{\{zeroToTen}\hlopt{+}\hlnum{1}\hldef{\}} \hlopt{+} \hlnum{2}\hlopt{^}\hldef{\{zeroToTen}\hlopt{-}\hlnum{1}\hldef{\}}
\end{alltt}
\end{kframe}
\end{knitrout}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{which}\hldef{(output} \hlopt{==} \hlnum{40}\hldef{)}
\end{alltt}
\begin{verbatim}
## [1] 5
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{zeroToTen[}\hlkwd{which}\hldef{(output} \hlopt{==} \hlnum{40}\hldef{)]}
\end{alltt}
\begin{verbatim}
## [1] 4
\end{verbatim}
...
\textbf{Solution:}
This approach would not work because you are only checking whether integers within a specific range are solutions. If the solution is not an integer then it will be impossible to find it using this method.
\end{enumerate}
\end{enumerate}
